  ##  <h1>This is a ReactJS sample of [Next.js](https://nextjs.org/) framework  implemented <b> Lazy Loading</b> and <b> Paging</b> on the two perspective of backend and frontend.</h1>
